                ...
                if post_grace_total <= 0:
                    ...
                    if override is not None:
                        if Decimal(override) > interest_dec:
                            ...
                            assumptions.append(
                                f"지정한 월 납입액({override:,}원)이 이자보다 작거나 같아서 무시하고, "
                                "자동으로 계산한 월 납입액을 사용했어요."
                            )
                    if effective_payment is None:
